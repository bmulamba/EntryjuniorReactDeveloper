                            ...
                            <div className='cart-prod-items-show' >
                                ...
                                <div className='item-prod-belt-right'>
                                    <div className='button-prod-quantity'>
                                        <button className='button-quantity' onClick={this.addToCart}>+</button>
  ...
  render() {
    return <div className='header-nav'>
        <div className='nav-bar' >
            <Link  to="/all" onClick={() => { localStorage['category'] = 'All' }}>ALL</Link>
            <Link  to="/clothes" onClick={() => { localStorage['category'] = 'Clothes' }}>CLOTHES</Link>
            <Link  to="/tech" onClick={() => { localStorage['category'] = 'Tech' }}>TECH</Link>
            <div className='nav-right-block'>
              <Link to="#" onMouseEnter={()=> this.setState({showCurrency: true})} onMouseLeave={()=> this.setState({showCurrency: false})}>
              ...
              <div className='nav-car-btn' to="#" onMouseEnter={()=> this.setState({showCart: true})} onMouseLeave={()=> this.setState({showCart: false})}>               
                ...
                (
                    ...
                    <div className='car-container'>
                        ...
                        (
                            <div className='cart-content-container-full'>
